...
function MovieDetailPage({ params }) {
    ...
    const movie = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$movies$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["movies"].find((m)=>m.id === id);
    ...
    // 関連動画の抽出
    const allRelated = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$movies$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["movies"].filter((m)=>m.id !== movie.id).filter((m)=>m.tags.some((tag)=>movie.tags.includes(tag)));
    const relatedMovies = [
        ...allRelated
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MovieDetailPage.useEffect": ()=>{
            const fetchLikes = {
                "MovieDetailPage.useEffect.fetchLikes": async ()=>{
                    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('movies').select('likes').eq('id', id).single();
                    if (data) {
                        setLikes(data.likes);
                    }
                }
            }["MovieDetailPage.useEffect.fetchLikes"];
            fetchLikes();
        }
    }["MovieDetailPage.useEffect"], [
        id
...
_s(MovieDetailPage, "+Dv3Yr79jMg6UsRuuKWuwgBK4q4=");
_c = MovieDetailPage;
var _c;
...
//# sourceMappingURL=src_d4ee310c._.js.map